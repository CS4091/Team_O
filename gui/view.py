...
class View(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.map_frame_button3.grid(
            column=2, row=0, padx=10, sticky=tk.E + tk.W
        )
        ...
        self.map_frame_map.grid(
            column=1, row=1, padx=250, pady=200, sticky=tk.E + tk.W
        )

        self.map_frame.grid(
            column=5, row=5, padx=100, pady=50, sticky=tk.E + tk.W
        )
